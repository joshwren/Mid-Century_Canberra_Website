(function ($, window, document) {
    var StickUp = function(elem, opts) {
        ...
        var initialize = function( elem, opts ) {
			...
			var placeholderId = $placeholder.find( '.main-nav' ).attr( 'id' ),
				placeholderMenuId = $placeholder.find( '.main-nav > ul' ).attr( 'id' );

			if ( placeholderId ) {
				$placeholder.find( '#' + placeholderId ).attr( 'id', placeholderId + '--clone' );
			}

			if ( placeholderMenuId ) {
				$placeholder.find( '#' + placeholderMenuId ).attr( 'id', placeholderMenuId + '--clone' );
			}
